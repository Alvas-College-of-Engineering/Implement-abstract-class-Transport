...
<head>
    ...
    <meta name="description" content="Add a new Truck to the Transport Management System">
    <title>Add Truck | Transport Management System</title>
...
<body>
    ...
    <nav class="nav">
        <div class="nav-inner">
            ...
            <a href="addTruck.jsp" class="active" id="nav-add-truck">🚛 Add Truck</a>
        </div>
    </nav>
    ...
    <main class="main">
        <div class="form-card">
            ...
            <div class="form-card-body">
                <form action="processTruck.jsp" method="post" id="add-truck-form">
                    <div class="form-group">
                        <label for="vehicleNumber">Vehicle Number</label>
                        <input type="text" id="vehicleNumber" name="vehicleNumber"
                               placeholder="e.g. TN-07-EF-9012" required>
                    </div>
                    <div class="form-group">
                        <label for="capacity">Capacity (Pallets)</label>
                    ...
                    <div class="form-group">
                        <label for="maxLoadTons">Max Load (Tons)</label>
                        <input type="number" id="maxLoadTons" name="maxLoadTons"
                               placeholder="e.g. 15.5" min="0.1" step="0.1" required>
                    </div>
                    <button type="submit" class="btn-submit" id="btn-add-truck">
                        ✦ Add Truck to Fleet
                    </button>
                </form>
            </div>
